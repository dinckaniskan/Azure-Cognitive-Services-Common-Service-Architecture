...
if useAzure:
    baseUrl = 'https://ocrdotnet.azurewebsites.net'
...
selections = [    
    ...
    },
    {
        ...
        'req_body': {
            "documents": [
                {
                    "url": "https://deseaisq.blob.core.windows.net/filedrop/upside_down.pdf?sp=r&st=2021-10-19T22:53:46Z&se=2022-10-20T06:53:46Z&spr=https&sv=2020-08-04&sr=c&sig=O%2Fypezh%2BvnVbaOEiSK1UtLEb9dyjsDecSOvg29VUdEA%3D",
                    "pages": 1
                }
            ]
        }
...
with st.form("my_form_trigger"):
    ...
    if submitted:
        ...
        resp = requests.post(f'{baseUrl}/api/PayslipExtractor', json=selected['req_body'])
        resp = resp.json()
